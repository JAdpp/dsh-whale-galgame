...
- **外观与内核解耦**：喜欢鲸鱼娘的机甲，又想用 Claude 或 GPT 进行深度对话（NTR?）角色形象与底层回复模型可随心搭配。
- **「小剧场」模式**：告别单一问答，解锁多模型娘联动日常、工作复盘短剧与专属里程碑剧情。
...
### 小剧场
小剧场为模型娘们提供了更具舞台感的剧情展现空间：
- **情景短剧与日常互动**：除常规对话外，可触发模型娘们之间的互动拌嘴、工作间歇小故事及特定情境短剧。
- **工作事件复盘剧**：结合近期的工作任务生成趣味复盘剧场（如“熬夜 Debug 后的鲸鱼娘慰劳会”）。
- **剧情图鉴与回放**：已解锁的小剧场片段会自动归档，随时可以在对话历史中回看经典互动。
